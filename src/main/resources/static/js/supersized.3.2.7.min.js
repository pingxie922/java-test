/*
 * 
 * Supersized - Fullscreen Slideshow jQuery Plugin Version : 3.2.7 Site :
 * www.buildinternet.com/project/supersized
 * 
 * Author : Sam Dunn Company : One Mighty Roar (www.onemightyroar.com) License :
...
(function(a) {
	a(document).ready(function() {
		a("body")
				.append('<div id="supersized-loader"></div><ul id="supersized"></ul>')
	});
	a.supersized = function(b) {
		...
		d._start = function() {
			...
			if (d.options.slides.length > 1) {
				if (d.options.slides.length > 2) {
					...
					q.load(function() {
								a(this).data("origWidth", a(this).width())
		...
		d.resizeNow = function() {
			return d.$el.each(function() {
				a("img", d.el).each(function() {
					thisSlide = a(this);
					var f = (thisSlide.data("origHeight") / thisSlide
							.data("origWidth")).toFixed(2);
					...
					if (d.options.fit_always) {
						...
						if ((h <= d.options.min_height)
							...
							if ((h / e) > f) {
								d.options.fit_landscape && f < 1
										? g(true)
										: j(true)
							} else {
								d.options.fit_portrait && f >= 1
										? j(true)
										: g(true)
							}
						} else {
		...
		d.nextSlide = function() {
			...
			if (d.options.thumbnail_navigation == 1) {
				vars.current_slide - 1 < 0
						? prevThumb = d.options.slides.length - 1
						: prevThumb = vars.current_slide - 1;
				a(vars.prev_thumb).html(a("<img/>").attr("src",
						d.options.slides[prevThumb].image));
				nextThumb = loadSlide;
				a(vars.next_thumb).html(a("<img/>").attr("src",
						d.options.slides[nextThumb].image))
			}
			if (typeof theme != "undefined"
					&& typeof theme.beforeAnimation == "function") {
			...
			if (d.options.slide_links) {
				...
				a(vars.slide_list + "> li").eq(vars.current_slide)
		...
		d.goTo = function(f) {
			...
			if (d.options.slide_links) {
				a(vars.slide_list + "> .current-slide")
						.removeClass("current-slide");
				a(vars.slide_list + "> li").eq((e - f))
						.addClass("current-slide")
			}
			if (d.options.thumb_links) {
				a(vars.thumb_list + "> .current-thumb")
						.removeClass("current-thumb");
				a(vars.thumb_list + "> li").eq((e - f))
		...
		d.afterAnimation = function() {
			...
			if (vars.update_images) {
				vars.current_slide - 1 < 0 ? setPrev = d.options.slides.length
